            ...
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="ovarflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
                            <img
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            ...
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Men Printed Pure Cotton Straight Kurta</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
                                <p className='text-semibold'>₹499 </p>
                                <p className='opacity-50 line-through'> ₹1499</p>
                                <p className='text-green-600 text-semibold'> % 66</p>
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3 '>
                                    ...
                                    <p className='opacity-50 text-sm'>38345 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3043 Reviwes</p>
                                </div>
                            </div>
                ...
                {/*Rating and Reviews */}
                <section>
                    <h1 className='font-semibold text-xl pb-6 font-serif'>Recent Review & Rating</h1>
                    <div className=' border p-5'>
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                <h1 className=' text-xl font-semibold pb-2'>Product Reting</h1>
                                <div className='flex items-center space-x-3'>
                ...
                <section className='pt-10'>
                    <h1 className='py-5 text-xl font-bold font-serif'>Similer Proudect</h1>
